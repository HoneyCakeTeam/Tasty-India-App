...
class DataManager(dataSource: CsvDataSource) : DataManagerInterface {
    ...
    override fun getAdvicesList(): List<Advice> = listOf(
        ...
        Advice(
            ...
            adviceDescription = "Choose foods with healthy fats, limit foods high in saturated fat, and avoid foods with trans fat. Plant oils, nuts, and fish are the healthiest sources"
        ),
        Advice(
